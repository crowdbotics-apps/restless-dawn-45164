"""
Django settings for restless_dawn_45164 project.
...
ROOT_URLCONF = 'restless_dawn_45164.urls'
...
WSGI_APPLICATION = 'restless_dawn_45164.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_dawn_45164 API",
    "DESCRIPTION": "API documentation for restless_dawn_45164 App",
    "VERSION": "v1",
}
